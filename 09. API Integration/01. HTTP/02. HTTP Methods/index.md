...
- [HTTP Status Codes](./3.%20HTTP%20Status%20Codes.md) - Response codes for each method
- [REST API Principles](./6.%20REST%20API%20Principles.md) - RESTful design
- [Error Handling](./7.%20Error%20Handling.md) - Handling errors for each method
- [HTTP Headers](./4.%20HTTP%20Headers.md) - Headers for each method
