...
_(See [HTTP Methods](./02.%20HTTP%20Methods.md) for details)_
...
- [HTTP Methods](./02.%20HTTP%20Methods.md) - GET, POST, PUT, PATCH, DELETE
- [HTTP Status Codes](./03.%20HTTP%20Status%20Codes.md) - Response status codes
- [HTTP Headers](./04.%20HTTP%20Headers.md) - Request and response headers
- [HTTP Request Response Structure](./05.%20HTTP%20Request%20Response%20Structure.md) - Detailed request/response structure
