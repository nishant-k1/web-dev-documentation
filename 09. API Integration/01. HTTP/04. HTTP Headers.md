...
- [HTTP Methods](./02.%20HTTP%20Methods.md) - Which headers for which methods
- [HTTP Status Codes](./03.%20HTTP%20Status%20Codes.md) - Headers in responses
- [HTTP Request Response Structure](./05.%20HTTP%20Request%20Response%20Structure.md) - How headers fit in structure
- [Authentication](./08.%20Authentication.md) - Authentication headers
