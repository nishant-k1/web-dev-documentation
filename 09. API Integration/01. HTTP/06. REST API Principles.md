...
- [HTTP Methods](./02.%20HTTP%20Methods.md) - HTTP methods for REST
- [HTTP Status Codes](./03.%20HTTP%20Status%20Codes.md) - Status codes for REST
- [HTTP Headers](./04.%20HTTP%20Headers.md) - Headers in REST APIs
- [Error Handling](./07.%20Error%20Handling.md) - Error handling in REST APIs
