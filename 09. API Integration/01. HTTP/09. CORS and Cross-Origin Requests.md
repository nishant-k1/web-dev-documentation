...
- [HTTP Headers](./04.%20HTTP%20Headers.md) - CORS headers details
- [HTTP Methods](./02.%20HTTP%20Methods.md) - Which methods trigger preflight
- [HTTP Status Codes](./03.%20HTTP%20Status%20Codes.md) - CORS error status codes
- [Error Handling](./07.%20Error%20Handling.md) - Handling CORS errors
