...
- [HTTP Methods](./02.%20HTTP%20Methods.md) - How to use HTTP methods
- [Error Handling](./07.%20Error%20Handling.md) - Error handling with clients
- [Authentication](./08.%20Authentication.md) - Authentication with clients
