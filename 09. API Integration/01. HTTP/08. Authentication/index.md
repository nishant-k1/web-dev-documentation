...
- [HTTP Headers](./4.%20HTTP%20Headers.md) - Authorization header details
- [HTTP Status Codes](./3.%20HTTP%20Status%20Codes.md) - 401 Unauthorized, 403 Forbidden
- [Error Handling](./7.%20Error%20Handling.md) - Handling auth errors
- [HTTP Methods](./2.%20HTTP%20Methods.md) - Authentication with different methods
