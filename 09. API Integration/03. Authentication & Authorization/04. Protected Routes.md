...
- [JWT Authentication](./01.%20JWT%20Authentication%20Workflow.md) - JWT for route protection
- [Session-Based Authentication](./02.%20Session-Based%20Authentication.md) - Sessions for route protection
- [HTTP Status Codes](../01.%20HTTP/03.%20HTTP%20Status%20Codes.md) - 401, 403 status codes
