...
- [JWT Authentication Workflow](./01.%20JWT%20Authentication%20Workflow.md) - Including roles in JWT
- [Protected Routes](./04.%20Protected%20Routes.md) - Route-level authorization
- [Security Best Practices](./08.%20Security%20Best%20Practices.md) - Authorization security
