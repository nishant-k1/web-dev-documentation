...
Yes — when people say vDOM or Real DOM, they almost always mean a tree structure.
...
Old vDOM → New vDOM → Diff → Update Real DOM

That was a simplified explanation.

## 🔹 vDOM = Virtual DOM Tree (Conceptually)
...
🔹 Modern React: Fiber Tree

Today, instead of a plain “virtual DOM object”, React uses a Fiber tree.
...
🔹 So We Actually Have Two Trees

1️⃣ Fiber Tree (Virtual Representation)
...
- Reconciliation compares Fiber trees
...
🔹 Is There One vDOM Tree or Many?
...
- If you mount React in two different DOM containers, then you’ll have two separate Fiber trees (one per root).

---

🔹 When Reconciliation Happens, Is It Global or Per Component?
...
It is not “reconcile whole app every time” blindly.

It reconciles the subtree rooted at the updated Fiber.

---

🔹 Does It Reconcile All Components Together?
...
- If Child props didn’t change and it’s memoized, it may bail out.
