...
- React does NOT do shallow comparison except in memo/pure (that too actually is reference equality check for non-primitive props and value equality check for primitives props, since shallow check both that's why we say shallow comparison here)
