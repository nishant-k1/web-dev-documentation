...
The **React component lifecycle** (mounting, updating, unmounting) is separate from the browser’s DOM lifecycle. For class and function component lifecycle, see **15. Component LifeCycle**, **16. LifeyCycle in Class Component**, and **17. LifeCycle in Function Component**.
...
For when reconciliation runs (first render vs later renders) and how the real DOM is created or updated, see **08. Reconciliation**.
