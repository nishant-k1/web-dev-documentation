...
CSS files are not "documents" in the same way as HTML/XML; they are style resources. For how CSS is parsed and why it becomes CSSOM, see **02. CSSOM**.

## Other File Types

Other file types are generally not considered documents in the same way:
