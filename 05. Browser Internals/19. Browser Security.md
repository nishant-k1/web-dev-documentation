...
- [Basic File Uploads](./7.%20Basic%20File%20Uploads.md) - File input security restrictions
- [HTTP Request Destinations](./3.%20HTTP%20Request%20Destinations.md) - CORS and cross-origin requests
