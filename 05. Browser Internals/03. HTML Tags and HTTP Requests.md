...
- `<h1>` through `<h6>`
- `<strong>`, `<em>`, `<b>`, `<i>`
- `<button>`, `<input>` (except `type="file"` - see [Basic File Uploads](./7.%20Basic%20File%20Uploads.md))
...
- [HTTP Request Destinations](./3.%20HTTP%20Request%20Destinations.md) - Where these requests go
- [Resource Loading Behavior](./4.%20Resource%20Loading%20Behavior.md) - How these resources load
- [Form Submissions](./5.%20Form%20Submissions.md) - Special case of forms
