...
It means: _"send this request to a server process running on my own machine."_
...
- [HTTP Request Destinations](./3.%20HTTP%20Request%20Destinations.md) - Where requests go
- [JavaScript Modules](./10.%20JavaScript%20Modules.md) - How modules are served in dev vs prod
