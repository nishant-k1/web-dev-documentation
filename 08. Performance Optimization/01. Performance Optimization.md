...
- Code splitting & Lazy loading (lazy loading enables code splitting)
- Minification
...
## 1️⃣ Two Categories of Optimizations

1. **Application-Level (You Control in Code)**
   ...
   These require explicit developer decisions.

2. **Build-Level (Bundler-Level Optimizations)**
   ...
   - These are handled by the bundler.
