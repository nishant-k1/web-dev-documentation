...
We normally don't use callbacks for handling asynchronous operations because of the callback hell. Callback hell is a situation when have lots of nested callbacks and it becomes difficult for us in terms of readability and error handling.
