# Non-Primitive Operations: Initialization and Mutation
...
7. `var`, `let` and `const` all offer mutation
...
For detailed information on copying and comparing non-primitives, see:
