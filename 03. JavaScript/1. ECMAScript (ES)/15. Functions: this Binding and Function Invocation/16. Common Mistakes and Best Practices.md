...
**✅ Solution 2: Use `new.target` check**
...
**✅ Solution 3: Use Classes (enforces `new`)**
...
**✅ Solution: Always Bind or Use Arrow Functions**
...
// ❌ Avoid: Constructor function (easy to forget 'new')
function Person(name) {
  this.name = name;
}
```
...
2. ❌ Losing context in callbacks
3. ❌ Losing context in event handlers
4. ❌ Using arrow functions as object methods (usually)
5. ❌ Not binding class methods
6. ❌ Confusing arrow and regular functions
7. ❌ Not understanding binding precedence
8. ❌ Using `call`/`apply`/`bind` on arrow functions
...
1. ✅ Always use `new` with constructors (or use classes)
2. ✅ Use arrow functions for callbacks
3. ✅ Bind class methods in constructor
4. ✅ Use arrow function class fields
5. ✅ Use strict mode
...
> - [15. Common Interview Questions.md](./15.%20Common%20Interview%20Questions.md) - Interview questions
