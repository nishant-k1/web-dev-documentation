...
1. ✅ Function is called standalone (not as method)
2. ✅ Not called with `new`
3. ✅ Not called with `call()`, `apply()`, or `bind()`
4. ✅ Not an arrow function
...
- ✅ Callbacks (setTimeout, forEach, etc.)
- ✅ Detached methods
- ✅ Nested functions
...
> - [12. this in Callbacks and Async.md](./12.%20this%20in%20Callbacks%20and%20Async.md) - Callbacks and default binding
