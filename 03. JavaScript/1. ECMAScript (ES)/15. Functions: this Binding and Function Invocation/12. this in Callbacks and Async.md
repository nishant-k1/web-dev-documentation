...
> 📖 **For details:** See [11. this in Event Handlers.md](./11.%20this%20in%20Event%20Handlers.md)
...
- ✅ `setTimeout`/`setInterval` - Use arrow functions or bind
- ✅ Array methods - Use arrow functions or `thisArg`
- ✅ Promises - Use arrow functions in `.then()`/`.catch()`
- ✅ async/await - Use arrow functions in nested functions
- ✅ Event listeners - Use bind or arrow functions
...
> - [11. this in Event Handlers.md](./11.%20this%20in%20Event%20Handlers.md) - Event handlers
