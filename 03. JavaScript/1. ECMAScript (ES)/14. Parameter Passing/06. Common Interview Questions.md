...
- ✅ Primitives: Pass by value (copies)
- ✅ Objects: Pass by reference (shared)
- ✅ Property modifications: Affect original
- ✅ Parameter reassignment: Doesn't affect original
- ✅ Default objects: Shared (create new each time)
- ✅ Destructuring: Primitives copied, objects referenced
