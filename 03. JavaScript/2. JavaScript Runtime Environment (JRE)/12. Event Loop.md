...
- Microtasks = high priority; **all** run before any macrotask. Sources: `Promise.then/catch/finally`, `async/await` continuation, `queueMicrotask`, `MutationObserver`/`IntersectionObserver`/`ResizeObserver`, `process.nextTick` (Node, even higher than microtasks).
...
- [Call Stack](06.%20Call%20Stack.md)
- [JavaScript Runtime Environment overview](02.%20JavaScript%20Runtime%20Environment.md)
- [Async Operations](14.%20Async%20Operations.md)
