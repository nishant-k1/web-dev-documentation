...
> 📖 **Parent Topic:** [04. Life Cycle of Execution Context](./04.%20Life%20Cycle%20of%20Execution%20Context.md)
...
### 🔥 TDZ Interview Trap 1: `typeof` is NOT Safe
...
### 🔥 TDZ Interview Trap 2: TDZ in Function Parameters
...
fails(undefined, 5); // ❌ ReferenceError: Cannot access 'b' before initialization
```

### 🔥 TDZ Interview Trap 3: TDZ in Same Line
...
function someFunction() {
  return y; // ❌ ReferenceError if called before y is initialized
}
```

### 🔥 TDZ Interview Trap 4: TDZ with Closures
...
### 🔥 TDZ Interview Trap 5: Class TDZ
...
### 🔥 TDZ Interview Trap 6: const in Switch
...
switch (x) {
  ...
  case 2:
    ...
    const y = 20; // ❌ SyntaxError - y already declared
    break;
}
...
// ⚠️ Behavior varies between strict/non-strict and browsers!
...
console.log(typeof bar); // ❌ ReferenceError - bar is the function's internal name
