...
Comprehensive guide to JavaScript's collection types: Map, Set, WeakMap, and WeakSet. Essential for interviews and modern JavaScript development.
...
| ----------- | ----------------- | ------------ | -------- | ------------- | --------------- |
| **Map**     | Any type          | Any type     | ✅ Yes   | ✅ Yes        | ❌ No           |
| **Set**     | N/A (values only) | Any type     | ✅ Yes   | ✅ Yes        | ❌ No           |
| **WeakMap** | Objects only      | Any type     | ❌ No    | ❌ No         | ✅ Yes          |
| **WeakSet** | N/A (values only) | Objects only | ❌ No    | ❌ No         | ✅ Yes          |
