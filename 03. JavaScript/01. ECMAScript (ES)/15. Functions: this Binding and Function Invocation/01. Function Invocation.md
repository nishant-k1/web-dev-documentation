...
4. **Indirect Invocation** (using `call()`, `apply()`)
...
> 📖 **For detailed information:** See [5. Explicit Binding (call, apply, bind).md](<./5.%20Explicit%20Binding%20(call,%20apply,%20bind).md>)
...
> 📖 **For detailed information:** See [7. Arrow Functions and this.md](./7.%20Arrow%20Functions%20and%20this.md)
