...
This document covers **coercion specifically in the context of operators**. For comprehensive type conversion and coercion information, see [05. Type Conversion and Coercion](../05.%20Type%20Conversion%20and%20Coercion/).
...
> 📖 **For comprehensive type conversion and coercion:** See [12. Type Conversion and Coercion/01. Type Conversion and Coercion.md](../05.%20Type%20Conversion%20and%20Coercion/01.%20Type%20Conversion%20and%20Coercion.md)
...
2. **`+` operator** has special behavior:
   - If either operand is a string → **string concatenation** (coerces to string)
   - Otherwise → **number addition** (coerces to number)
...
- [12. Type Conversion and Coercion/](../05.%20Type%20Conversion%20and%20Coercion/) - Comprehensive type conversion guide
- [01. Operators.md](./01.%20Operators.md) - All operators overview
- [02. Operators Precedence.md](./02.%20Operators%20Precedence.md) - Operator precedence
