...
- ❌ Losing context when passing methods as handlers
- ❌ `this` referring to element instead of object
- ❌ Cannot remove event listeners (need bound reference)

### Solutions

- ✅ `bind()` in constructor or addEventListener
...
> - [11. this in Classes.md](./10.%20this%20in%20Classes.md) - Class event handlers
