...
structuredClone is not part of the ECMAScript (ECMA-262) language spec. It belongs to the runtime / host environment, originally defined by the Web platform, and later adopted by others.
