...
> **For arrow functions: The value of `this` depends on where an arrow function is defined — not how that arrow function is invoked.**
...
// ✅ Regular function - this = instance
...
- ✅ Callbacks (preserve `this`)
- ✅ Event handlers (preserve `this`)
- ✅ Nested functions (preserve outer `this`)
- ✅ Array methods (forEach, map, etc.)
- ✅ setTimeout/setInterval

### When NOT to Use Arrow Functions

- ❌ Object methods (usually want `this` = object)
- ❌ Prototype methods
- ❌ Constructors (not allowed)
- ❌ When you need `this` to change dynamically
...
> - [13. this in Callbacks and Async.md](./12.%20this%20in%20Callbacks%20and%20Async.md) - Arrow functions in callbacks
> - [12. this in Event Handlers.md](./11.%20this%20in%20Event%20Handlers.md) - Arrow functions in events
