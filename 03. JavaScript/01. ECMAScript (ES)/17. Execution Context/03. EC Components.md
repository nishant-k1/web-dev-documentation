...
> 📖 **For detailed hoisting coverage:** See [18. Hoisting](../18.%20Hoisting/) for comprehensive examples, hoisting types, and TDZ details.
...
- **Note:** Function declarations using function keyword are NOT stored here—they go in the Variable Environment.
...
> 📖 **Deep Dive:** See [05. this](./05.%20this.md) for detailed examples and interview traps.
