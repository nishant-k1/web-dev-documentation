...
- Every regular function you define this way automatically gets a `.prototype` property. Even if you never use it with new.
- In JavaScript, there is no special “constructor function type.” A normal function that you call using new.
- Methods defined inside objects do not have .prototype. It can't be used as constructor.
- Arrow Functions don't have .prototype. It can't be used as constructor.

The .prototype property exists only on:

Functions that have the internal [[Construct]] capability.

Meaning:

They are allowed to be used with new.

Arrow functions and method shorthand functions do not have [[Construct]].
...
| Function Type                          | Has `.prototype`? | Can use `new`? |
| -------------------------------------- | ----------------- | -------------- |
| Normal function                        | ✅ Yes            | ✅ Yes         |
| Class                                  | ✅ Yes            | ✅ Yes         |
| Arrow function                         | ❌ No             | ❌ No          |
| Method shorthand (`obj = { fn() {} }`) | ❌ No             | ❌ No          |

### Built-in Functions That Aren’t Constructors

Some built-in functions exist but are not constructors.

- Math
- JSON
- Reflect

These are objects, not constructor functions.
...
- 5 Methods defined inside objects do not have .prototype.
