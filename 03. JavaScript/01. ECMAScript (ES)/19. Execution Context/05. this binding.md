...
> 📖 **Parent Topic:** [03. Components of Execution Context](./03.%20Components%20of%20Execution%20Context.md)
...
| --------- | ------------------------------------- | -------------------- | --------------- |
| `call()`  | `func.call(thisArg, arg1, arg2, ...)` | ✅ Yes               | Function result |
| `apply()` | `func.apply(thisArg, [argsArray])`    | ✅ Yes               | Function result |
| `bind()`  | `func.bind(thisArg, arg1, arg2, ...)` | ❌ No                | New function    |
...
### 🔥 Interview Trap: bind() Returns a Function!
...
// ❌ Common mistake - forgetting to invoke
greet.bind(obj); // Does nothing! Just returns a function
console.log("done");

// ✅ Correct - invoke the bound function
greet.bind(obj)(); // "Test"
// OR
...
### 🔥 Interview Trap: bind() Cannot Be Overridden
...
### 🔥 Interview Trap: Arrow Functions Ignore call/apply/bind
...
setTimeout(obj.greet, 100); // undefined ❌ - `this` is lost!
...
const obj = {
  ...
  // ❌ Arrow function - this is lexical (probably global/undefined)
  arrow: () => {
    console.log(this.name);
  },
};
...
console.log(obj.getName()); // "Original" ✅

const extracted = obj.getName;
console.log(extracted()); // undefined ❌ - context lost!
...
// ❌ Wrong - this will be the DOM element, not button object
