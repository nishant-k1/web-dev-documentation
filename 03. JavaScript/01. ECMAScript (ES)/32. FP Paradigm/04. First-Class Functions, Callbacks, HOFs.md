...
A higher-order function is a function that can take one or more functions as arguments or can return a function as its result or be doing both. In other words, it treats functions as first-class citizens.
...
[Refer To](`03. JavaScript/01. ECMAScript (ES)/20. Closures`)
