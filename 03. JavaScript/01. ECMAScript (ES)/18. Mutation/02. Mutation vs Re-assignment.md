...
| **const behavior**  | ✅ Allowed             | ❌ Not allowed                |
...
📖 See: [Ways to Mutate Objects and Arrays](./01.%20Mutation%20Overview.md)

📖 See: [Ways to Prevent Mutation](./03.%20Preventing%20Mutation.md)

📖 See: [Assignment](../../15.%20Assignments/) for assignment details

📖 See: [Copying](../../17.%20Copying/) for creating copies without mutation
