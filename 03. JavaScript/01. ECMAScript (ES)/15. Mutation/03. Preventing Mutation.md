...
obj.age = 35; // ❌ Fails silently in non-strict mode, throws in strict mode
console.log(obj.age); // 30 (unchanged)

// Nested objects are NOT frozen
const nested = { user: { name: "John" } };
Object.freeze(nested);
nested.user.name = "Jane"; // ⚠️ Still works! (shallow freeze)
```
...
📖 See: [Object.freeze() details](../../04.%20Data%20Types/12.%20Objects.md#-4-immutability--control) for more information
...
📖 See: [Shallow Copy](../../14.%20Copying/04.%20Shallow%20Copy.md) for detailed shallow copy methods
...
const deepCopy = JSON.parse(JSON.stringify(obj)); // ⚠️ Limitations
...
📖 See: [Deep Copy](../../14.%20Copying/05.%20Deep%20Copy.md) for complete deep cloning guide
...
```js
const obj = { name: "John" };
obj.name = "Jane"; // ✅ Allowed - mutation is fine
console.log(obj.name); // "Jane"

const arr = [1, 2, 3];
arr.push(4); // ✅ Allowed - mutation is fine
...
📖 See: [Copying](../../14.%20Copying/) - Comprehensive copying guide
📖 See: [Practical Patterns](./04.%20Practical%20Patterns.md) - React/Redux patterns
📖 See: [Common Pitfalls](./05.%20Common%20Pitfalls.md) - Mistakes to avoid
