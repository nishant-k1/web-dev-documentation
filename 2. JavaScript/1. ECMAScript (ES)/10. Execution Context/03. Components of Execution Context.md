...
2. **Variable Environment**:
   ...
   **🔥 Critical: Each Function Call Gets Its OWN Variable Environment**
   ...
   - This is why closures work — each closure captures its own variable environment
   ...
   - `locker1` → Locker #101 with its own key
   - `locker2` → Locker #102 with its own key
