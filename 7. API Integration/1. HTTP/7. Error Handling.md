...
- [HTTP Status Codes](./3.%20HTTP%20Status%20Codes.md) - Understanding status codes
- [HTTP Methods](./2.%20HTTP%20Methods.md) - Error handling for each method
- [REST API Principles](./6.%20REST%20API%20Principles.md) - Error formats in REST
- [HTTP Clients](./http%20clients.md) - Error handling with different clients
