...
- [HTTP Methods](./2.%20HTTP%20Methods.md) - Which status codes for which methods
- [Error Handling](./7.%20Error%20Handling.md) - How to handle errors
- [REST API Principles](./6.%20REST%20API%20Principles.md) - RESTful status codes
- [HTTP Headers](./4.%20HTTP%20Headers.md) - Headers related to status codes
