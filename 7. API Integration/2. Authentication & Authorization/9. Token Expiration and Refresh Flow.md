...
```javascript
if (error.response?.status === 401 && error.response.data?.error === "Refresh token expired") {
...
- [Refresh Tokens](./5.%20Refresh%20Tokens.md) - Refresh token pattern
- [JWT Authentication Workflow](./1.%20JWT%20Authentication%20Workflow.md) - Token creation
- [Security Best Practices](./8.%20Security%20Best%20Practices.md) - Token security
- [Error Handling](../1.%20HTTP/7.%20Error%20Handling.md) - Error handling patterns
